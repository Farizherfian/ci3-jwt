...
class Kategori_barang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $kategori = $this->db->get('kategori_barang')->result_array();
    ...
    public function ubah($id_kategori)
	{
    	...
    	if ($this->Kategori_model->ubah($id_kategori, $data)) {
    ...
    public function hapus($id_kategori)
    {
        ...
        if ($this->Kategori_model->hapus($id_kategori)) {
    ...
    public function hitung()
    {
        ...
        $data = $this->db->get('kategori_barang')->num_rows();
